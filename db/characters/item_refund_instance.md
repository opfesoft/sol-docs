...
The GUID of the item bought by the vendor. See [item\_instance.guid](item_instance.md#guid)

### player\_guid

The GUID of the player eligible for the refund. See [characters.guid](characters.md#guid)

...
Contains all the individual talent data for each character. This is only used as a storage table, values get read from here and written to [character\_spell](character_spell.md), and vice-versa, when a player switches specs.

...
Example for ACE 7.1.3, installation in "~/sol-srv/lib/ace":

- Get package:
```
curl -L 'https://github.com/DOCGroup/ACE_TAO/releases/download/ACE%2BTAO-7_1_3/ACE+TAO-7.1.3.tar.gz' >ACE+TAO-7.1.3.tar.gz
tar -xzf ACE+TAO-7.1.3.tar.gz
```

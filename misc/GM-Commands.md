...
|go gobject|1|Syntax: .go gobject #object_guid Teleport your character to gameobject with guid #object_guid. .go gobject id #gameobject_entry Teleport your character to a gameobject that was spawned from the template with this entry. If more than one gameobject is found, then you are teleported to the first that is found in the database.|
...
|gobject set state|2|Syntax: .gobject set state #guid #type #state Gameobject with DB guid #guid and type #type state changed to #state.|
...
|morph|2|Syntax: .morph #displayid Change your current model id or the model id of the targeted unit to #displayid. If no #displayid is specified take over the model id of the targeted unit.|

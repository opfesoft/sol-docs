...
This page describes the usage of EffectMiscValue and other spell aura values. Contains only spell auras that have a known usage of EffectMiscValue or other specific values.
...
- EffectMiscValueA: ID from [Spell Effect](SpellEffect.md) to become immune to.
...
- EffectMiscValueA: [Creature Immunity](../db/world/creature_template.md)
...
- EffectMiscValueA: ID from AuraStateType (https://gitlab.com/opfesoft/sol/-/blob/master/src/server/game/Miscellaneous/SharedDefines.h#L1170)
